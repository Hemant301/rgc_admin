...
Future<void> _showNotification({String body = '', String title = ''}) async {
  ...
  const AndroidNotificationDetails androidPlatformChannelSpecifics =
    ...
    playSound: false,
    // sound: RawResourceAndroidNotificationSound('chicken'),
  );
...
Future<void> showBigPictureNotification(
  ...
  final AndroidNotificationDetails androidPlatformChannelSpecifics =
      AndroidNotificationDetails('rgc_admin', 'rgc_admin',
          importance: Importance.max,
          priority: Priority.high,
          playSound: false,
          // sound: const RawResourceAndroidNotificationSound('chicken'),
